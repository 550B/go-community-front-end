<template>
   <el-scrollbar height="95vh">
        <div style="margin-left: 40px; margin-right: 40px;">
            <div class="bigBox">
                <el-divider />
                <h1 style="margin-top: 30px; font-size: 35px; margin-bottom: 20px;">公告管理</h1>
            </div>
    ...
    <!-- 发布后确认信息弹出框 -->
    <div class="text-wrapper">
        <el-dialog v-model="dialogVisible" title="确认信息" width="30%" draggable>
            ...
            <template #footer>
                <span class="dialog-footer">
                    <el-button type="primary" @click="refreshAnn">确认</el-button>
                </span>
            </template>
        </el-dialog>
    </div>
...
/* #building {
    background: url("../assets/bgink.jpg");
    width: 100%;
    height: 100%;
    position: fixed;
